...
Instead, the Moogle Charm removes stumble rates entirely.
...
Enable support for msu-1 pcm soundtrack. Suggested soundtracks are "Synthetic Origins by Matthew Valente" and "Pixel Remaster official soundtrack". You can find them (together with pcm 37 needed for bnw) at https://www.zeldix.net/t1335-final-fantasy-vi-j-final-fantasy-iii-us.

-multitap (Sir Fig Newton)
Adds multitap (4 players) support. Overwrite the controller option into the config screen
...
They alter player or/and enemy speed. Note: Use only 1 patch. Both leads to enemy to get 3x turns compared to the player: use it at your own risk.
