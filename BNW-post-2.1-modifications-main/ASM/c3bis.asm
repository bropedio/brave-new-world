...
;	CMP #$FF
;	BEQ .buzz
;	JSR $8308   ; table pointer description
;	LDY #$1590  ; bet denied index
;	JSR $5745   ; pick up to print text
;	JMP $AD14
;.buzz
	JMP $AD0E	
	
warnpc $C40000
; write "bet denied" in colosseum menu

;org $ED7990
;	db "This item is not in|your inventory",$00
