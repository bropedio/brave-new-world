...
; party selection, the main menu will be opened.
;
; Hidon
...
; ###############################################
; Patch bug in merged equip menu descriptions
...
org $C372BF
  LDA #$FF           ; default to no menu next
  JSR MenuNext       ; maybe prepare main menu opening (A=04)
...
warnpc $C372EA       ; TODO: Freespace above here
...
ShufflePool:         ; 69 bytes
  ...
  JSR FloatCont      ; is this the Floating Continent lineup
