...
; Patch: Visible Magitek Doors
; Author: Khaos
;
; The doors in certain Magitek factory inspired Kefka's Tower rooms are
; very difficult to see. This patch lightens the color used for their
; edges, making them more visible.
;
; This change exposed a strange use of a lower door tile in one map,
; which has been replaced with a non-door tile.
...
; --------------------------------------------------------------------------
; Replace one lower door tile with something more suitable, now that the
; door tiles stand out more

compressed $DDCFEB
org $00046F : db $BA
warncompressed $DDDAA1
